...
class ViewController: UIViewController {
    ...
    func setupScrollView(){
        ...
        mainStackView.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor,constant: 120).isActive = true
    ...
    func setupViews(){
        ...
        label2.bottomAnchor.constraint(equalTo: mainStackView.bottomAnchor).isActive = true
    }
